...
<div class="edit container border border-secondary rounded text-light my-5 p-5">
    ...
    <div class="row">
        <div class="col-12 col-lg-6 mx-auto">
            ...
            <button type="button" class="mt-3 btn btn-sm btn-outline-danger text-center" name="deleteAvatar" data-bs-toggle="modal" data-bs-target="#deleteAvatar" data-bs-dismiss="modal">Supprimer mon avatar</button>
        </div>
...
<div class="modal fade" id="deleteAvatar" tabindex="-1" aria-labelledby="deleteAvatarLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteAvatarLabel">Confirmation de Suppression</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Souhaitez-vous vraiment supprimer votre avatar?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <form method="POST">
                    <input type="hidden" id="deleteID" name="deleteID">
                    <button type="submit" class="btn btn-danger" name="deleteAvatar">Supprimer</button>
                </form>
            </div>
        </div>
    </div>
